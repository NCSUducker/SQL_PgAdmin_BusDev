...
-- 3) Manager of each department with the following: department number, department name,
...
-- 5) List first, last name, and sex for employees with the first name 'Hercules' and
